...
module.exports = [
  ...
  new SlashCommandBuilder().setName('locker').setDescription('ตู้แก๊งส่วนกลาง [IMT] IMMORTAL')
    ...
    .addSubcommand(s => s.setName('add').setDescription('เพิ่มของและจำนวนเข้าตู้แก๊ง')
      .addStringOption(o => o.setName('name').setDescription('ชื่อของ เช่น red money หรือ money').setRequired(true).setMaxLength(80))
      .addIntegerOption(o => o.setName('quantity').setDescription('จำนวน').setRequired(true).setMinValue(0).setMaxValue(1000000000000))
    ...
    .addSubcommand(s => s.setName('edit').setDescription('ตั้งจำนวนใหม่และหน่วยของตู้แก๊ง')
      ...
      .addIntegerOption(o => o.setName('quantity').setDescription('จำนวนใหม่').setRequired(true).setMinValue(0).setMaxValue(1000000000000))
    ...
    .addSubcommand(s => s.setName('remove').setDescription('ลบรายการจากตู้แก๊ง')
      ...
      .addIntegerOption(o => o.setName('quantity').setDescription('จำนวนที่ลบ เว้นว่าง = ลบทั้งรายการ').setMinValue(1).setMaxValue(1000000000000)))
