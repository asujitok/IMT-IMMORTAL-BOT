...
module.exports = [
  ...
  new SlashCommandBuilder().setName('locker').setDescription('ผู้ดูแล: จัดการตู้แก๊งส่วนกลาง')
    ...
    .addSubcommand(s => s.setName('remove').setDescription('ลบรายการจากตู้แก๊ง หรือลดจำนวนบางส่วน')
      .addStringOption(o => o.setName('name').setDescription('ชื่อของ').setRequired(true))
      .addIntegerOption(o => o.setName('quantity').setDescription('จำนวนที่ต้องการลบ ถ้าไม่ใส่จะลบทั้งรายการ').setMinValue(1)))
